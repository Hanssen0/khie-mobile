...
public class HexString
{
    ...
    public static String hexify(final int val) {
        return HexString.hexChars[(val & 0xFF & 0xF0) >>> 4] + HexString.hexChars[val & 0xF];
    }
    ...
    public static String hexifyShort(final int val) {
        return HexString.hexChars[(val & 0xFFFF & 0xF000) >>> 12] + HexString.hexChars[(val & 0xFFF & 0xF00) >>> 8] + HexString.hexChars[(val & 0xFF & 0xF0) >>> 4] + HexString.hexChars[val & 0xF];
    }

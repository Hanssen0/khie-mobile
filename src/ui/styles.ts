...
export const styles = StyleSheet.create({
  ...
  balanceBlock: { alignItems: "center", gap: 4, paddingTop: 24 },
  ...
  homeActions: { flexDirection: "row", gap: 12, marginBottom: 8 },
  amountRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  amountInput: { flex: 1 },
  recipientAddressInput: { height: 112, textAlignVertical: "top" },
  addressCopyRow: { width: "100%", minHeight: 48, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 8 },
  ...
  khieContent: { gap: 16 },
  peerOverview: { gap: 4 },
  peerHeaderRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 },
  peerMetadata: { gap: 12 },
  khieMethod: { gap: 12 },
  scanConnectorButton: { marginBottom: 8 },
  endpointCopyRow: { width: "100%", minHeight: 48, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 8 },
  endpointCopyRowPressed: { opacity: 0.6 },
  endpointCopyText: { flex: 1, minWidth: 0 },
  endpointCopyTextCompact: { flex: 0 },
